...
public class concatenation {
   /*
    String: represents the squence of characters, used for storing text
            String vlaues are surrendered by a double qoute
            
            Concatenation : combinig, linking things togther ==>
    */
...
// Example: 		
	...
	//	System.out.println(  (1+2) - "3");
		...
		System.out.println( 12 + '3');
			//				12+  51 =63
		// if we concate char to number, representative number of char will be concated
